...
export default function FirstStepPop({ onClose }) {
    ...
    <div className="fixed inset-0 bg-black bg-opacity-50 flex items-start justify-center z-50 pt-10 sm:pt-20">
      <div className="bg-white rounded-xl p-6 sm:p-8 max-w-sm sm:max-w-md w-full relative">
        ...
        <p className="mb-2 text-center">
          Be one of the first 25 students to unlock exclusive early bird
          benefits — including a chance to win a <br />
          <span className="font-bold">FREE one-way ticket</span>
          <br /> to your study abroad destination!
        </p>
        <p className="mb-6 text-sm text-gray-500 text-center">
          Limited to the first 25 sign-ups only.
          <span className="text-blue-600"> *T&Cs apply</span>.
        </p>
